...
forest_green = (99 / 255, 126 / 255, 118 / 255, 1)
light_brown = (198 / 255, 151 / 255, 116 / 255, 1)
off_pink = (248 / 255, 223 / 255, 212 / 255, 1)
off_white = (255 / 255, 239 / 255, 232 / 255, 1)
...
class Welcome(Screen):
    def __init__(self, **kwargs):
        ...
        title = Label(text="PyCurrency", font_size='24sp', color=light_brown)
        intro_txt = Label(text="Are you ready to Convert?", color=light_brown)
        self.btn_next = Button(text="Convert Now", size_hint=(0.3, 0.2), pos_hint={'center_x': 0.5}, background_color=light_brown)
...
class ConvertScreen(Screen):
    def __init__(self, **kwargs):
        ...
        amt_text = Label(text="Enter Amount:", halign="left", color=light_brown, bold=True)
        from_txt = Label(text="From Currency:", halign="left", color=light_brown, bold=True)
        ...
        self.convert_btn = Button(text="Convert Now", size_hint=(0.5, None), pos_hint={'center_x': 0.5}, background_color=off_pink, bold=True)
